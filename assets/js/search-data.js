    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-preprint-for-our-new-long-read-metagenome-assembler-myloasm-is-out",
          title: 'Preprint for our new long-read metagenome assembler, myloasm, is out!',
          description: "",
          section: "News",},{id: "news-our-long-read-metagenome-assembler-myloasm-is-now-published-in-nature-biotechnology",
          title: 'Our long-read metagenome assembler, myloasm, is now published in Nature Biotechnology.',
          description: "",
          section: "News",},{id: "news-our-new-long-read-amplicon-sequence-variant-asv-generation-method-savont-is-now-uploaded-to-biorxiv",
          title: 'Our new long-read amplicon sequence variant (ASV) generation method, savont, is now uploaded...',
          description: "",
